...
pub extern fn vfwprintf(noalias __s: [*c]__FILE, noalias __format: [*c]const wchar_t, __arg: [*c]struct___va_list_tag_5) c_int;
...
pub extern fn vfwscanf(noalias __s: [*c]__FILE, noalias __format: [*c]const wchar_t, __arg: [*c]struct___va_list_tag_5) c_int;
...
pub fn nccell_load_char(arg_n: ?*struct_ncplane, arg_c: [*c]nccell, arg_ch: u8) callconv(.c) c_int {
    ...
    return nccell_load(n, c, @as([*c]u8, @ptrCast(@alignCast(&gcluster))));
}
pub fn nccell_load_egc32(arg_n: ?*struct_ncplane, arg_c: [*c]nccell, arg_egc: u32) callconv(.c) c_int {
    ...
    _ = memcpy(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&gcluster))))), @as(?*const anyopaque, @ptrCast(&egc)), @sizeOf(u32));
...
pub fn nccell_load_ucs32(arg_n: ?*struct_ncplane, arg_c: [*c]nccell, arg_u: u32) callconv(.c) c_int {
    ...
    _ = &utf8;
    if (notcurses_ucs32_to_utf8(&u, @as(c_uint, @bitCast(@as(c_int, 1))), @as([*c]u8, @ptrCast(@alignCast(&utf8))), @sizeOf([4]u8)) < @as(c_int, 0)) {
        return -@as(c_int, 1);
    }
    var utf8asegc: u32 = undefined;
    _ = &utf8asegc;
    _ = memcpy(@as(?*anyopaque, @ptrCast(&utf8asegc)), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&utf8))))), @sizeOf([4]u8));
...
pub fn ncplane_pututf32_yx(arg_n: ?*struct_ncplane, arg_y: c_int, arg_x: c_int, arg_u: u32) callconv(.c) c_int {
    ...
    _ = &ps;
    _ = memset(@as(?*anyopaque, @ptrCast(&ps)), @as(c_int, 0), @sizeOf(mbstate_t));
    var s: usize = wcrtomb(@as([*c]u8, @ptrCast(@alignCast(&utf8c))), @as(wchar_t, @bitCast(u)), &ps);
    _ = &s;
    if (s == @as(usize, @bitCast(@as(c_long, -@as(c_int, 1))))) {
        return -@as(c_int, 1);
    }
    utf8c[s] = '\x00';
    return ncplane_putegc_yx(n, y, x, @as([*c]u8, @ptrCast(@alignCast(&utf8c))), null);
}
...
pub fn ncplane_putwc_stained(arg_n: ?*struct_ncplane, arg_w: wchar_t) callconv(.c) c_int {
    ...
    _ = &warr;
    return ncplane_putwstr_stained(n, @as([*c]wchar_t, @ptrCast(@alignCast(&warr))));
}
...
// zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// zig-linux-x86_64-0.14.0/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_copy.h:11:9
